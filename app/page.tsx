...
export default function Home() {
  ...
  <nav className="top-0 left-0 w-full mt-4 z-50 p-4 pb-16">
    <ul className="flex justify-center items-center mx-w-7xl gap-8 mr-8 text-sm font-medium">
      ...
      <li className="hover:scale-105 active:scale-95" title="blog"><a target="_blank" href="https://day-lee.github.io/blog/"><img width="48" height="48" src="https://img.icons8.com/external-xnimrodx-lineal-xnimrodx/64/external-blog-blogger-and-influencer-xnimrodx-lineal-xnimrodx.png" alt="external-blog-blogger-and-influencer-xnimrodx-lineal-xnimrodx"/></a></li>
    </ul>
  </nav>
  <div className="flex flex-col items-center text-sm gap-4 justify-center max-w-4xl mx-auto p-4 space-y-8">
    ...
    <section className="w-full">
      ...
      <ul className="flex justify-center mx-w-7xl gap-8 mr-8 text-sm font-medium">
        ...
        <li className="hover:scale-105 active:scale-95" title="blog"><a target="_blank" href="https://day-lee.github.io/blog/"><img width="56" height="56" src="https://img.icons8.com/external-xnimrodx-lineal-xnimrodx/64/external-blog-blogger-and-influencer-xnimrodx-lineal-xnimrodx.png" alt="external-blog-blogger-and-influencer-xnimrodx-lineal-xnimrodx"/></a></li>
      </ul>
      </div>
    </section>
  </div>
